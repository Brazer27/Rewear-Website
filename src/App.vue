<template>
  ...
  <router-link to="/login" class="text-[#70ffc8] hover:text-teal-100 mr-4">
    <button class="bg-[#70ffc8] text-gray-700 py-1 px-3 rounded-full hover:bg-teal-100 transition">
      Login/Register
    </button>
  </router-link>

  <a href="https://github.com/Brazer27">
    <img class="w-9 rounded-full" src="https://www.freeiconspng.com/img/910" alt="profile">
  </a>
  </div>
